...
public class MadgwickAHRS {
	...
	/** Not working yet **/
	public float[] rotateVector3(float[] vector)
	{
		float[] res4D = rotateVector4(new float[] {0.0f, vector[0], vector[1], vector[2]} );
		return new float[] {res4D[1], res4D[2], res4D[3]};
	}
	
	/** Not working yet **/
	public float[] rotateVector4(float[] vector)
	{
		float length = (float) Math.sqrt(vector[0]*vector[0] + vector[1]*vector[1] + vector[2]*vector[2] + vector[3]*vector[3]);
		float[] quaternionInv = new float[4];
		...
		float[] res = multiplyQuaternions(quaternion, multiplyQuaternions(vector, quaternionInv));
		res[0] *= length;
		res[1] *= length;
		res[2] *= length;
		res[3] *= length;
	...
	/** Not working yet **/
	public float[] multiplyQuaternions(float[] left, float[] right)
	{
